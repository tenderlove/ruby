...
extern "C" {
    ...
    pub fn rb_c_method_tracing_currently_enabled() -> bool;
    ...
    pub fn rb_get_cfp_pc(cfp: *const rb_control_frame_struct) -> *mut VALUE;
    pub fn rb_get_cfp_sp(cfp: *const rb_control_frame_struct) -> *mut VALUE;
